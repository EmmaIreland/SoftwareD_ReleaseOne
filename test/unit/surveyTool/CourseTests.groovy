...
class CourseTests extends GrailsUnitTestCase {
    ...
    void testCourseCreation() {
		Course course = new Course(courseName:'Amish 101',student:roger,term:'Spring',year:'2012', manager:sheepHerder)
		assertTrue course.validate()
		assertNull course.errors['courseName']
    }
	
	void testBlankCourse() {
		Course course = new Course(courseName:'',student:roger,term:'Spring',year:'2012', manager:sheepHerder)
		assertFalse course.validate()
		assertEquals 'blank', course.errors['courseName']
	}
	
	void testCourseWithNoStudent() {
		Course course = new Course(courseName:'Amish 101',term:'Spring',year:'2012', manager:sheepHerder)
		assertTrue course.validate()
	}
	
	void testToString() {
		Course course = new Course(courseName:'Amish 101',term:'Spring',year:'2012',student:roger, manager:sheepHerder)
		assertTrue course.validate()
