                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="teamAssignments"><g:message code="project.teamAssignments.label" default="Team Assignments" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: projectInstance, field: 'teamAssignments', 'errors')}">
...
<g:link controller="projectTeamAssignment" action="create" params="['project.id': projectInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'projectTeamAssignment.label', default: 'ProjectTeamAssignment')])}</g:link>
