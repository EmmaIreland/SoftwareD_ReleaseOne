...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'studentTeamAssignment.label', default: 'StudentTeamAssignment')}" />
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${studentTeamAssignmentInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
